        ...
        <div class="container-fluid" >
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li id="art" <?php if(isset($sess)&&($acc=='artist')){ ?>style="display:inline;"<?php } ?> ><a href="artistprofile.php"><span class="glyphicon glyphicon-headphones"></span> <?php echo $sess ?></a></li>
                    <li id="usr" <?php if(isset($sess)&&($acc=='user')) { ?>style="display:inline;"<?php } ?> ><a href="userprofile.php"><span class="glyphicon glyphicon-headphones"></span> <?php echo $sess ?></a></li>
