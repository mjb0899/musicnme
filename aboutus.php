        ...
        <div class="container-fluid" >
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li <?php if(!isset($sess)) { ?>style="display:none;"<?php } ?> ><span class="glyphicon glyphicon-headphones"></span></li>
                    <li <?php if(isset($sess)&&($acc=='artist')){ ?>style="display:none;"<?php } ?> ><a href="userprofile.php"><?php echo $sess ?></a></li>
                    <li <?php if(isset($sess)&&($acc=='user')) { ?>style="display:none;"<?php } ?> ><a href="artistprofile.php"> <?php echo $sess ?></a></li>
