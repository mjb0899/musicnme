                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse in">
                                <div class="panel-body">
                                    ...
                                    include("dbConnect.php");
                                    $sql_query = "SELECT description from statuses where title='status' and username='theweekend'  ORDER BY dateposted DESC LIMIT 1";
                                    $result = $db -> query($sql_query);
                                    while($row = $result -> fetch_array()) {
        ...
        <div class="two">
            <div class="share_align">
                <div class="container">
                  ...
                  <textarea class="form-control" rows="2" id="comment" name="status" placeholder="What's on your mind?">
                  </textarea>
                    ...
                    <textarea class="form-control" rows="2" id="comment" name="description_text"  placeholder="Say something about your post">
                    </textarea>
