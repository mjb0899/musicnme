                    ...
                    while($row = $result -> fetch_array()){
                        ...
                        if($file_title==="upload") {
                            if(in_array($file_type,$allowed_image)) {
                                ...
                                echo "<div class=\"media\">
                     <div class=\"media-left\">
                     <img src=\"$file_path\" class=\"media-object\" style=\"width:60px\">
                     </div>
                     <div class=\"media-body\">
                     <h4 class=\"media-heading\">$post_owner</h4>
                     <p>$status</p>
                     ...
                     <div style='height: 500px; width: 500px; background-color: #212121;border:2px solid black; margin: auto'>
                     ...
                     <div style='border-left:2px solid #ff3333; padding: 1rem; margin-top: 1rem'>
